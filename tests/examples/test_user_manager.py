...
def test_read_user(test_user_manager: UserManager):
    """Test reading a user by username."""

    test_user_manager.create_user("readuser", "Pass123!")
    user = test_user_manager.read({"username": "readuser"})
...
def test_update_user(test_user_manager: UserManager):
    ...
    updated = test_user_manager.update_user(
        1, username="updateduser", password="NewPass123!", activated=False
    )
...
def test_delete_user(test_user_manager: UserManager):
